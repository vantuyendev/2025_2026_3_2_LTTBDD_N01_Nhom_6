...
void _eventModelSerialize(
  ...
  writer.writeBool(offsets[2], object.isReminded);
...
EventModel _eventModelDeserialize(
  ...
  final object = EventModel(
    ...
    isReminded: reader.readBoolOrNull(offsets[2]) ?? true,
...
extension EventModelQueryFilter
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> isDoneEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isDone',
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> isRemindedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isReminded',
        value: value,
      ));
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteEqualTo(
    String? value, {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'note',
        value: '',
  ...
  QueryBuilder<EventModel, EventModel, QAfterFilterCondition> noteIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'note',
        value: '',
...
extension EventModelQuerySortBy
  ...
  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByIsDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.desc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByIsReminded() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isReminded', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByIsRemindedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isReminded', Sort.desc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByNote() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> sortByNoteDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension EventModelQuerySortThenBy
  ...
  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByIsDoneDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDone', Sort.desc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByIsReminded() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isReminded', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByIsRemindedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isReminded', Sort.desc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByNote() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.asc);
    });
  }

  QueryBuilder<EventModel, EventModel, QAfterSortBy> thenByNoteDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'note', Sort.desc);
    });
  }
...
extension EventModelQueryWhereDistinct
  ...
  QueryBuilder<EventModel, EventModel, QDistinct> distinctByIsDone() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isDone');
    });
  }

  QueryBuilder<EventModel, EventModel, QDistinct> distinctByIsReminded() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isReminded');
    });
  }

  QueryBuilder<EventModel, EventModel, QDistinct> distinctByNote(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension EventModelQueryProperty
  ...
  QueryBuilder<EventModel, bool, QQueryOperations> isDoneProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isDone');
    });
  }

  QueryBuilder<EventModel, bool, QQueryOperations> isRemindedProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isReminded');
    });
  }

  QueryBuilder<EventModel, String?, QQueryOperations> noteProperty() {
    return QueryBuilder.apply(this, (query) {
